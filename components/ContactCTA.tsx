...
export default function ContactCTA() {
  return (
    <section className="py-40 px-14 text-center relative max-lg:px-8 max-md:py-24 max-md:px-5" id="contact">
      {/* Background watermark */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-mono text-[clamp(8rem,18vw,16rem)] font-extrabold text-warm-gray pointer-events-none whitespace-nowrap z-0 tracking-[-0.05em] max-md:hidden">
        UNBOUND
      </div>

      <div className="relative z-1">
        <ScrollReveal>
          <h2 className="font-sans text-[clamp(2.5rem,5vw,4rem)] font-extrabold tracking-[-0.04em] text-ink mb-4">
            Let&apos;s build something.
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={1}>
          <p className="text-[1.1rem] text-text-secondary mb-10 max-w-[440px] mx-auto leading-[1.65]">
        ...
        <ScrollReveal delay={2}>
          <div className="flex gap-3 justify-center max-sm:flex-col max-sm:items-center">
            ...
            <a
              href="mailto:hello@unboundapps.com"
